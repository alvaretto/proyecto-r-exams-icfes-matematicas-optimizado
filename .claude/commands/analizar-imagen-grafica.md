...
Usa el skill `gestionar-estado-graficador` para inicializar el estado persistente:
...
## 6. Inicio de Generación Automática

**IMPORTANTE**: Después de completar el análisis, automáticamente inicia el ciclo de auto-refinamiento:

1. Ejecutar `/auto-refinar-grafico tikz 95 10` para TikZ
2. Una vez TikZ alcance 95% o se complete, continuar con Python
3. Una vez Python alcance 95% o se complete, continuar con R

**El proceso es completamente automático** - NO preguntar al usuario entre iteraciones.
Solo informar del progreso y resultado final.

El comando `/auto-refinar-grafico` maneja internamente:
- Generación inicial del código
- Comparación visual
- Refinamiento iterativo hasta alcanzar umbral (95%) o máximo de iteraciones (10)
- Validación automática al alcanzar umbral

## Referencias

- `skills/analizar-imagen-grafica/skill.md` - Skill de análisis visual completo
