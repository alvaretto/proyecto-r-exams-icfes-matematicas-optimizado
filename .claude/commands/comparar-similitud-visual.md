...
7. **Comportamiento Automático (NO preguntar al usuario)**:

**IMPORTANTE**: Este comando NO debe preguntar al usuario. Simplemente:

- Reporta la puntuación y diferencias identificadas
- Retorna el resultado para que el ciclo automático continúe
- El comando `/auto-refinar-grafico` maneja la lógica de decisión automáticamente

Si se invoca manualmente (fuera del ciclo automático), mostrar el reporte y las correcciones sugeridas sin preguntar.

## Uso

```
/comparar-similitud-visual [lenguaje]
```
...
- `skills/comparar-similitud-visual/skill.md` - Skill de comparación detallada con métricas cuantitativas
