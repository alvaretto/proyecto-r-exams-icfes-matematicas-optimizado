...
Versión Python/matplotlib v2 - Mejorado para similitud con TikZ
...
def generar_diagrama_flujo(precio_reserva=22.5, precio_sin_reserva=17,
                           output_file="python_output_v2.png"):
    """
    ...
    def crear_circulo_peq(x, y, numero, radius=0.1):
        circulo = Circle((x, y), radius, facecolor=color_circulo,
    ...
    # Círculo pequeño "1" dentro de la caja 2 superior
    crear_circulo_peq(x2_sup + 1.55, y_superior + alto_caja/2 + 0.02, 1)
    ...
    # Círculo pequeño "1" dentro de la caja 2 inferior
    crear_circulo_peq(x2_sup + 1.55, y_inferior + alto_caja/2 + 0.02, 1)
...
if __name__ == "__main__":
    output = generar_diagrama_flujo(22.5, 17, "python_output_v2.png")
