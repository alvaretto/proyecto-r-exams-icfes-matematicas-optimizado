...
% === PASO 3 (Resultado) - Círculo 3 posicionado abajo ===
...
% Círculo 3 posicionado abajo a la izquierda de la caja
\node[paso, below left=0.15cm and 0.3cm of caja3.south west] (p3) {3};
