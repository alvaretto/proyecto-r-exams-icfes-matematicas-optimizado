...
Versión Python/matplotlib v4 - Círculos pequeños mejor posicionados
...
def generar_diagrama_flujo(precio_reserva=22.5, precio_sin_reserva=17,
                           output_file="python_output_v4.png"):
    """
    ...
    # Círculo pequeño "1" - después de "paso" y antes de "por"
    crear_circulo_peq(x2_sup + ancho_caja2/2 + 0.42, y_superior + alto_caja/2, 1)
    ...
    # Círculo pequeño "1" - después de "paso" y antes de "por"
    crear_circulo_peq(x2_sup + ancho_caja2/2 + 0.42, y_inferior + alto_caja/2, 1)
...
if __name__ == "__main__":
    output = generar_diagrama_flujo(22.5, 17, "python_output_v4.png")
