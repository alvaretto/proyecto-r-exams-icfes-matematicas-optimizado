...
# La respuesta correcta es siempre la gráfica circular por semana (originalmente índice 3)
respuesta_correcta_schoice <- paste("Gastos del", vehiculo)

# Encontrar en qué posición está la respuesta correcta en el orden mostrado
# Como la gráfica circular por semana era originalmente la tercera (índice 3), buscamos dónde quedó después del shuffle
indice_original_correcto <- 3  # "Circular por semana" era el índice 3 en nombres_graficas_base original
indice_respuesta_correcta <- which(orden_presentacion == indice_original_correcto)
...
test_that("Validación de aleatorización de gráficas", {
  ...
  expect_equal(length(opciones_graficas), 4)
  expect_equal(respuesta_correcta_schoice, paste("Gastos del", vehiculo))  # Respuesta correcta es exactamente el tipo
...
mapeo_r = {
    'grafica_1': '", mapeo_graficas$letra[1], "',
    'grafica_2': '", mapeo_graficas$letra[2], "',
    'grafica_3': '", mapeo_graficas$letra[3], "',
    'grafica_4': '", mapeo_graficas$letra[4], "'
}
