...
plt.title('", titulo_gastos, "', fontsize=14, fontweight='bold')
plt.axis('equal')
...
Basándose en su análisis anterior, **seleccione qué tipo de gráfica permite identificar más fácilmente qué categoría de gasto representa el `r texto_analisis` del gasto total mensual**:
...
- Esta opción permite visualizar directamente qué categoría representa el `r texto_analisis` del total mensual
