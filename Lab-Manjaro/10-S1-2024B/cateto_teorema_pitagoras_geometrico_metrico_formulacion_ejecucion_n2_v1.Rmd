...
\\begin{tikzpicture}[scale=2]
  % Cuadrado exterior - Coordenadas exactas del archivo de referencia
  \\draw (0,0) rectangle (2,2);

  % Triángulo rectángulo en la esquina inferior izquierda
  \\draw (0,0) -- (1,0) -- (0,1) -- cycle;

  % Símbolo de ángulo recto - Pequeño cuadrado en esquina
  \\draw (0.2,0) rectangle (0,0.2);

  % Cuadrado interior rotado 45° - Coordenadas exactas de referencia
  \\draw (1,0) -- (0,1) -- (1,2) -- (2,1) -- cycle;

  % ETIQUETAS CON POSICIONAMIENTO EXACTO DEL ARCHIVO DE REFERENCIA
  % Etiqueta "1" debajo del lado inferior
  \\node at (0.5,-0.2) {$1$};

  % Etiqueta "x" a la izquierda del lado izquierdo
  \\node at (-0.2,0.5) {$x$};

  % Etiqueta "√2" en el centro de la hipotenusa
  \\node at (0.5,1.0) {$\\sqrt{2}$};
\\end{tikzpicture}
'
```
