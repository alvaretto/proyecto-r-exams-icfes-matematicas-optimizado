...
\\begin{tikzpicture}[scale=2.5]
  ...
  % Línea de conexión desde etiqueta hacia hipotenusa
  \\draw[green!60!black, thin, ->] (0.55,0.45) -- (0.45,0.55);
  % Etiqueta para hipotenusa "√2" (separada de la línea)
  \\node[green!60!black, font=\\bfseries] at (0.6,0.4) {$\\sqrt{2}$};
