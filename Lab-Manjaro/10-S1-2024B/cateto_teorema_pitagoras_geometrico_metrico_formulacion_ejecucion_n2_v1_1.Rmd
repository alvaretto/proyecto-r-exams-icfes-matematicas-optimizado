...
generar_datos <- function() {
  ...
  contextos_problema <- c(
    paste("En el triángulo rectángulo mostrado en la figura, uno de los catetos",
          "mide 1 unidad y la hipotenusa mide √2 unidades. Margarita debe",
          "determinar el valor del cateto x"),
    paste("El diagrama presenta un triángulo rectángulo donde un cateto tiene",
          "longitud 1 y la hipotenusa mide √2. Carlos necesita encontrar el",
          "valor del cateto x"),
    paste("En la figura se observa un triángulo rectángulo con un cateto de",
          "longitud 1 y una hipotenusa de √2 unidades. Ana debe calcular el",
          "valor del cateto x"),
    paste("El triángulo rectángulo de la imagen tiene un cateto que mide 1",
          "unidad y una hipotenusa de √2. Luis requiere hallar el valor del",
          "cateto x"),
    paste("En el gráfico se muestra un triángulo rectángulo donde uno de los",
          "catetos mide 1 y la hipotenusa es √2. María debe encontrar el",
          "valor del cateto x")
  )
...
# GRÁFICA TikZ SIMPLIFICADA - SOLO TRIÁNGULO RECTÁNGULO PRINCIPAL
# Eliminados elementos innecesarios para mayor claridad educativa
tikz_triangulo_rectangulo <- '
\\begin{tikzpicture}[scale=3]
  % TRIÁNGULO RECTÁNGULO PRINCIPAL CON RELLENO
  % Relleno del triángulo para mayor claridad visual
  ...
  % Etiqueta para hipotenusa "√2" con fondo blanco
  \\node[green!60!black, font=\\bfseries, fill=white, inner sep=2pt]
        at (0.75,0.85) {$\\sqrt{2}$};
\\end{tikzpicture}
'
```
...
include_tikz(tikz_triangulo_rectangulo,
             name = "triangulo_rectangulo",
             markup = "markdown",
             format = typ,
...
Para resolver este problema, aplica el teorema de Pitágoras siguiendo este procedimiento:

**Paso 1.** Aplicando el teorema de Pitágoras, calcula la hipotenusa usando la fórmula $\sqrt{x^2 + 1^2}$ y verifica que obtienes $`r diagonal_interior_tex`$.

**Paso 2.** Eleva al cuadrado el resultado del paso 1 y confirma que obtienes el número 2, es decir: $(\sqrt{2})^2 = 2$.

Usando esta información, ¿cuál es el valor del cateto $x$?
...
- La hipotenusa del triángulo mide $`r diagonal_interior_tex`$ unidades
- Debemos encontrar el valor del cateto $x$

**Resolución paso a paso aplicando el teorema de Pitágoras:**

Del **Paso 1**: Aplicamos el teorema de Pitágoras: $\sqrt{x^2 + 1^2} = `r diagonal_interior_tex`$

Del **Paso 2**: Elevamos al cuadrado ambos lados: $(`r diagonal_interior_tex`)^2 = 2$

Verificamos el **Paso 2**: $(\sqrt{2})^2 = 2$ ✓

Ahora, elevando al cuadrado la ecuación del **Paso 1**:
$(x^2 + 1^2) = (\sqrt{2})^2$

Simplificando: $x^2 + 1 = 2$

Despejando $x^2$: $x^2 = 2 - 1 = 1$

Por lo tanto: $x = \sqrt{1} = 1$
