...
# Aleatorizar el tipo de pregunta
tipos_pregunta <- c(
  "solo_bien1",
  "solo_bien2",
  "solo_bien3",
...
# Seleccionar aleatoriamente el tipo de pregunta
...
distractor3 <- personas_bien1_bien3  # El valor dado en el problema
...
Si `r personas_bien1_bien3` `r termino_personas` de el(la) `r contexto` poseen `r bien1` y `r bien3`, ¿cuántas personas poseen `r texto_pregunta`?
