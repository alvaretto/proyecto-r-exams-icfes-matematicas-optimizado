...
# Utilizamos signif() para mantener precisión en los cálculos
distractor1 <- signif(round(respuesta_correcta * sample(c(0.7, 0.8, 1.2, 1.3), 1)), 4)  # Variación porcentual
distractor2 <- signif(round(total_personas * sample(c(0.15, 0.2, 0.25, 0.3), 1)), 4)    # Porcentaje arbitrario del total
distractor3 <- signif(valor_condicion, 4)  # El valor dado en la condición inicial

# Asegurarse de que todos los distractores son diferentes de la respuesta correcta
# Usamos ajustes más precisos para evitar problemas de redondeo
if (abs(distractor1 - respuesta_correcta) < 1) distractor1 <- signif(distractor1 + sample(5:15, 1), 4)
if (abs(distractor2 - respuesta_correcta) < 1) distractor2 <- signif(distractor2 - sample(5:15, 1), 4)
if (abs(distractor3 - respuesta_correcta) < 1) distractor3 <- signif(distractor3 + sample(5:15, 1), 4)

# Asegurarse de que todos los distractores son diferentes entre sí
# Usamos una tolerancia pequeña para comparaciones
while (length(unique(signif(c(distractor1, distractor2, distractor3), 3))) < 3) {
  if (abs(distractor1 - distractor2) < 1) distractor1 <- signif(distractor1 + sample(5:10, 1), 4)
  if (abs(distractor2 - distractor3) < 1) distractor2 <- signif(distractor2 - sample(5:10, 1), 4)
  if (abs(distractor1 - distractor3) < 1) distractor3 <- signif(distractor3 + sample(5:10, 1), 4)
}
...
X = (`r valor_condicion` × 100) ÷ `r if(tipo_condicion == "solo_bien1") p_solo_bien1 else if(tipo_condicion == "solo_bien2") p_solo_bien2 else if(tipo_condicion == "solo_bien3") p_solo_bien3 else if(tipo_condicion == "bien1_bien2") p_bien1_bien2 else p_bien1_bien3`
X = `r valor_condicion * 100` ÷ `r if(tipo_condicion == "solo_bien1") p_solo_bien1 else if(tipo_condicion == "solo_bien2") p_solo_bien2 else if(tipo_condicion == "solo_bien3") p_solo_bien3 else if(tipo_condicion == "bien1_bien2") p_bien1_bien2 else p_bien1_bien3`
X = `r sprintf("%.4f", valor_condicion * 100 / (if(tipo_condicion == "solo_bien1") p_solo_bien1 else if(tipo_condicion == "solo_bien2") p_solo_bien2 else if(tipo_condicion == "solo_bien3") p_solo_bien3 else if(tipo_condicion == "bien1_bien2") p_bien1_bien2 else p_bien1_bien3))`
X = `r round(valor_condicion * 100 / (if(tipo_condicion == "solo_bien1") p_solo_bien1 else if(tipo_condicion == "solo_bien2") p_solo_bien2 else if(tipo_condicion == "solo_bien3") p_solo_bien3 else if(tipo_condicion == "bien1_bien2") p_bien1_bien2 else p_bien1_bien3))` `r termino_personas` (redondeando al entero más cercano)
```
...
Y = (`r if(tipo_pregunta == "solo_bien1") p_solo_bien1 else if(tipo_pregunta == "solo_bien2") p_solo_bien2 else if(tipo_pregunta == "solo_bien3") p_solo_bien3 else if(tipo_pregunta == "bien1_bien2") p_bien1_bien2 else p_bien1_bien3` × `r total_personas`) ÷ 100
Y = `r if(tipo_pregunta == "solo_bien1") p_solo_bien1 * total_personas else if(tipo_pregunta == "solo_bien2") p_solo_bien2 * total_personas else if(tipo_pregunta == "solo_bien3") p_solo_bien3 * total_personas else if(tipo_pregunta == "bien1_bien2") p_bien1_bien2 * total_personas else p_bien1_bien3 * total_personas` ÷ 100
Y = `r sprintf("%.4f", if(tipo_pregunta == "solo_bien1") p_solo_bien1 * total_personas / 100 else if(tipo_pregunta == "solo_bien2") p_solo_bien2 * total_personas / 100 else if(tipo_pregunta == "solo_bien3") p_solo_bien3 * total_personas / 100 else if(tipo_pregunta == "bien1_bien2") p_bien1_bien2 * total_personas / 100 else p_bien1_bien3 * total_personas / 100)`
Y = `r round(if(tipo_pregunta == "solo_bien1") p_solo_bien1 * total_personas / 100 else if(tipo_pregunta == "solo_bien2") p_solo_bien2 * total_personas / 100 else if(tipo_pregunta == "solo_bien3") p_solo_bien3 * total_personas / 100 else if(tipo_pregunta == "bien1_bien2") p_bien1_bien2 * total_personas / 100 else p_bien1_bien3 * total_personas / 100)` `r termino_personas` (redondeando al entero más cercano)
```
