...
Se realizó un(a) estudio a un grupo de colaboradores de un(a) sociedad
sobre el tipo de bienes que poseen. Los estadísticas se presentan en la
gráfica.

\includegraphics[width=0.7\textwidth,height=\textheight]{grafico_circular.png}

Si 168 colaboradores de la sociedad poseen carro y condominio, ¿cuántas
...
\tightlist
\item
  Sabemos que 168 colaboradores poseen carro y condominio.
\item
  Según el gráfico circular, este grupo representa el 21\% del total.
\item
  También observamos en el gráfico que las personas que poseen solo
  condominio representan el 15\% del total.
\end{itemize}

\subsubsection{Paso 2: Calcular el número total de
personas}\label{paso-2-calcular-el-nuxfamero-total-de-personas}

Para encontrar el total de colaboradores en la sociedad, utilizamos la
siguiente relación de proporcionalidad:

Si 21\% del total = 168 colaboradores Entonces 100\% del total = X
colaboradores

Aplicando regla de tres: * X = (168 × 100\%) ÷ 21\% * X = 16800 ÷ 21 * X
= 800 colaboradores

Por lo tanto, el total de colaboradores en la sociedad es 800.

\subsubsection{Paso 3: Calcular el número de personas que poseen solo
condominio}\label{paso-3-calcular-el-nuxfamero-de-personas-que-poseen-solo-condominio}

Una vez conocido el total, podemos calcular cuántas personas poseen solo
condominio utilizando el porcentaje correspondiente del gráfico
circular:

Si 100\% del total = 800 colaboradores Entonces 15\% del total = Y
colaboradores

Aplicando regla de tres: * Y = (15\% × 800) ÷ 100\% * Y = (15 × 800) ÷
100 * Y = 120 * Y = 120 colaboradores
...
\tightlist
\item
  carro y condominio: 168 colaboradores (21\% del total)
\item
  Solo condominio: 120 colaboradores (15\% del total)
\item
  Solo residencia: 296 colaboradores (37\% del total)
\item
  Solo carro: 72 colaboradores (9\% del total)
\item
  carro y residencia: 144 colaboradores (18\% del total)
\end{itemize}

La suma de todas estas categorías es 800 colaboradores, que coincide con
nuestro total calculado de 800 colaboradores.

\subsubsection{Conclusión}\label{conclusiuxf3n}

Por lo tanto, 120 colaboradores de la sociedad poseen solo condominio.
