...
# La respuesta correcta es el número de personas con solo bien2
...
Si `r personas_bien1_bien3` `r termino_personas` de el(la) `r contexto` poseen `r bien1` y `r bien3`, ¿cuántas personas poseen solo `r bien2`?
...
* También observamos en el gráfico que las personas que poseen solo `r bien2` representan el `r p_solo_bien2`% del total.
...
### Paso 3: Calcular el número de personas que poseen solo `r bien2`
Una vez conocido el total, podemos calcular cuántas personas poseen solo `r bien2` utilizando el porcentaje correspondiente del gráfico circular:

Si 100% del total = `r total_personas` `r termino_personas`.

Entonces `r p_solo_bien2`% del total = Y `r termino_personas`

Aplicando regla de tres:

* Y = (`r p_solo_bien2`% × `r total_personas`) ÷ 100%
* Y = (`r p_solo_bien2` × `r total_personas`) ÷ 100
* Y = `r p_solo_bien2 * total_personas / 100`
...
### Conclusión
Por lo tanto, `r respuesta_correcta` `r termino_personas` de la `r contexto` poseen solo `r bien2`.
