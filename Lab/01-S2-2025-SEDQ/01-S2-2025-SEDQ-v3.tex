...
\CommentTok{\# La respuesta correcta es el número de personas que poseen solo bien\_transporte (carro/auto)}
...
Se realizó un(a) investigación a un grupo de personas de una corporación
comercial sobre el tipo de bienes que poseen. Los resultados se
...
Si 250 personas de el(la) corporación poseen coche y(e) piso, ¿cuántas
...
\item
  4\% de las personas tienen solo coche (este es el dato que buscamos)
\item
  Sabemos que 250 personas tienen coche y piso
\end{itemize}

Paso 1: Calcular el número total de personas en la corporación. Si 250
...
\[\text{Total de personas} = \frac{250 \times 100\%}{18\%} = 1389\]

Paso 2: Calcular cuántas personas tienen solo coche. El porcentaje de
personas que tienen solo coche es 4\% del total, por lo tanto:

\[\text{Personas con solo coche} = \text{Total de personas} \times \frac{\text{Porcentaje de personas con solo coche}}{100\%}\]

\[\text{Personas con solo coche} = 1389 \times \frac{4\%}{100\%} = 56\]

Por lo tanto, 56 personas poseen solo coche.
...
exsolution: 0001 exshuffle: TRUE exsection: Interpretación de
