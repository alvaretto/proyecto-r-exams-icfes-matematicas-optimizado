...
# Aleatorizar las preguntas para el formato cloze
...
Answerlist
----------
- Si `r personas_bien1_bien3` `r termino_personas` de la `r contexto` poseen `r bien1` y `r bien3`, ¿cuántas personas poseen `r texto_pregunta1`?
...
Sabemos que `r personas_bien1_bien3` `r termino_personas` poseen `r bien1` y `r bien3`, lo que representa el `r p_bien1_bien3`% del total según el gráfico.

Para calcular el total de personas:
* Total = (`r personas_bien1_bien3` × 100%) ÷ `r p_bien1_bien3`%
* Total = `r personas_bien1_bien3 * 100` ÷ `r p_bien1_bien3`
