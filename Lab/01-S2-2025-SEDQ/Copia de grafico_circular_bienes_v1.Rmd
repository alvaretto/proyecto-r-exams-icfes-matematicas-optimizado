...
# Crear figura con tamaño controlado - Aumentar altura para dar más espacio
...
patches, texts, autotexts = plt.pie(
    ...
    autopct='%d%%',
    pctdistance=0.75,  # Acercar al centro para evitar solapamiento
...
# Crear leyenda por separado con mejor formato
plt.axis('equal')  # Asegurar que el gráfico sea un círculo
plt.legend(
    labels,
    loc='upper left',
    bbox_to_anchor=(-0.1, 1.15),  # Mover más arriba para evitar solapamiento
    fontsize=9,  # Aumentar tamaño de fuente
    frameon=True,  # Agregar marco
    facecolor='white',  # Fondo blanco
    edgecolor='lightgray',  # Borde gris claro
