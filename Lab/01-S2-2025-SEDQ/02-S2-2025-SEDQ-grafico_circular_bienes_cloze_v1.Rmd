...
tipo_pregunta2 <- sample(bienes_pregunta2[bienes_pregunta2 != tipo_pregunta1], 1)
...
Answerlist
----------
- Si `r valor_condicion` `r termino_personas` de la `r contexto` poseen `r texto_condicion`, ¿cuántas personas poseen `r texto_pregunta1`?
- Si se escoge una persona del grupo al azar, ¿cuál es la probabilidad de que tenga `r texto_pregunta2`?
- ¿Cuántas personas de la `r contexto` fueron encuestadas?
...
Como calculamos en la primera pregunta, el total de personas encuestadas es `r total_personas` `r termino_personas`.
