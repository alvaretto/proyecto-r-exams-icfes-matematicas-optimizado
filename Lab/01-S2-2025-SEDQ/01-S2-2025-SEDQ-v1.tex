...
Se realizó un(a) censo a un grupo de personas de una firma comercial
sobre el tipo de bienes que poseen. Los resultados se presentan en la
gráfica.

\textbackslash begin\{figure\}

\{\centering \textbackslash includegraphics{[}width=0,75\linewidth{]}\{grafico\_circular\}

\}

\textbackslash end\{figure\}

Si 120 personas de el(la) firma poseen coche y(e) apartamento, ¿cuántas
personas poseen solo apartamento?
...
\tightlist
\item
  19\% de las personas tienen coche y apartamento
\item
  27\% de las personas tienen solo apartamento (este es el dato que
  buscamos)
\item
  Sabemos que 120 personas tienen coche y apartamento
\end{itemize}

Paso 1: Calcular el número total de personas en la firma. Si 120
personas representan el 19\% del total, entonces:

\[\text{Total de personas} = \frac{\text{Personas con coche y apartamento} \times 100\%}{\text{Porcentaje de personas con coche y apartamento}}\]

\[\text{Total de personas} = \frac{120 \times 100\%}{19\%} = 632\]

Paso 2: Calcular cuántas personas tienen solo apartamento. El porcentaje
de personas que tienen solo apartamento es 27\% del total, por lo tanto:

\[\text{Personas con solo apartamento} = \text{Total de personas} \times \frac{\text{Porcentaje de personas con solo apartamento}}{100\%}\]

\[\text{Personas con solo apartamento} = 632 \times \frac{27\%}{100\%} = 170\]

Por lo tanto, 170 personas poseen solo apartamento.
...
exsolution: 0010 exshuffle: TRUE exsection: Interpretación de
