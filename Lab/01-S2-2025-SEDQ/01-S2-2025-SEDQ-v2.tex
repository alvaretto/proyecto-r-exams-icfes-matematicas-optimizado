...
Se realizó un(a) estudio a un grupo de personas de una firma comercial
sobre el tipo de bienes que poseen. Los resultados se presentan en la
gráfica.

\includegraphics[width=0.75\linewidth]{grafico_circular_16578355455c8c49058dad5790078efd.pdf}

Si 60 personas de el(la) firma poseen carro y(e) casa, ¿cuántas personas
poseen solo casa?
...
\tightlist
\item
  19\% de las personas tienen carro y casa
\item
  20\% de las personas tienen solo casa (este es el dato que buscamos)
\item
  Sabemos que 60 personas tienen carro y casa
\end{itemize}

Paso 1: Calcular el número total de personas en la firma. Si 60 personas
representan el 19\% del total, entonces:

\[\text{Total de personas} = \frac{\text{Personas con carro y casa} \times 100\%}{\text{Porcentaje de personas con carro y casa}}\]

\[\text{Total de personas} = \frac{60 \times 100\%}{19\%} = 316\]

Paso 2: Calcular cuántas personas tienen solo casa. El porcentaje de
personas que tienen solo casa es 20\% del total, por lo tanto:

\[\text{Personas con solo casa} = \text{Total de personas} \times \frac{\text{Porcentaje de personas con solo casa}}{100\%}\]

\[\text{Personas con solo casa} = 316 \times \frac{20\%}{100\%} = 63\]

Por lo tanto, 63 personas poseen solo casa.
