...
```{r grafico_circular, echo=FALSE, fig.align='center', out.width='.75\\linewidth'}
...
extol: 0
exextra[tipoicfes]: SAI
exextra[nivel]: Básico
exextra[componente]: Aleatorio
exextra[competencia]: Interpretación y representación
exextra[tema]: Interpretación de gráficos circulares
