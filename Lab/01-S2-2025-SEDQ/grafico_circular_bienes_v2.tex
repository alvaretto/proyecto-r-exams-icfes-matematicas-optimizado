...
\CommentTok{\# La respuesta correcta es el número de personas con solo bien2}
...
Se realizó un(a) consulta a un grupo de empleados de un(a) organización
...
Si 72 empleados de el(la) organización poseen carro y departamento,
¿cuántas personas poseen solo residencia?
...
Por lo tanto, el total de empleados en la organización es 300.

\subsubsection{Paso 3: Calcular el número de personas que poseen solo
residencia}\label{paso-3-calcular-el-nuxfamero-de-personas-que-poseen-solo-residencia}

Una vez conocido el total, podemos calcular cuántas personas poseen solo
residencia utilizando el porcentaje correspondiente del gráfico
circular:

Si 100\% del total = 300 empleados.

Entonces 30\% del total = Y empleados
...
\tightlist
\item
  carro y departamento: 72 empleados (24\% del total)
\item
  Solo departamento: 90 empleados (22\% del total)
\item
  Solo residencia: 90 empleados (30\% del total)
\item
  Solo carro: 15 empleados (5\% del total)
\item
  carro y residencia: 57 empleados (19\% del total).
\end{itemize}

La suma de todas estas categorías es 300 empleados, que coincide con
nuestro total calculado de 300 empleados.

\subsubsection{Conclusión}\label{conclusiuxf3n}

Por lo tanto, 90 empleados de la organización poseen solo residencia.
