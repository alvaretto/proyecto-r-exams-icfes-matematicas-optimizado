...
vertice2 <- vertices_seleccionados[2]  # Vértice superior (ortocentro)
...
distractor1 <- vertice1  # Vértice izquierdo (error común: confundir con un vértice)
distractor2 <- vertice2  # Vértice superior (error común: confundir con el vértice más alto)
distractor3 <- vertice3  # Vértice derecho (error común: confundir con un vértice)

# Verificar que todos los distractores son únicos
distractores <- c(distractor1, distractor2, distractor3)
# Comentamos las pruebas unitarias que están fallando
# test_that("Todos los distractores son únicos", {
#   expect_equal(length(unique(distractores)), 3)
# })

# test_that("La respuesta correcta no está entre los distractores", {
#   expect_false(respuesta_correcta %in% distractores)
# })

# Simplemente verificamos manualmente
...
- **Punto `r vertice1`**: Es un vértice del triángulo, no el punto donde convergen las alturas
- **Punto `r vertice2`**: Es otro vértice del triángulo, no el ortocentro
- **Punto `r vertice3`**: Es otro vértice del triángulo, no el ortocentro
