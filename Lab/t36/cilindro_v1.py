...
ax.annotate("Diámetro externo", xy=(0, altura + 0.8), xytext=(0, altura + 0.8),
            ha='center', va='center', fontsize=11)
ax.arrow(-radio_externo, altura + 0.6, 2*radio_externo, 0, head_width=0.1, head_length=0.1, fc='black', ec='black')
ax.arrow(radio_externo, altura + 0.6, -2*radio_externo, 0, head_width=0.1, head_length=0.1, fc='black', ec='black')
...
# Radio externo
ax.annotate("Radio externo", xy=(radio_externo/2, -0.5), xytext=(radio_externo/2, -0.5),
            ha='center', va='center', fontsize=11)
ax.arrow(0, -0.3, radio_externo, 0, head_width=0.1, head_length=0.1, fc='black', ec='black')
