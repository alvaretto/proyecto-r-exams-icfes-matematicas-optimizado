...
\begin{tikzpicture}[scale=0.7]
  ...
  % Líneas de medida
  \draw[linea_medida] (-2,1.5) -- (2,1.5) node[midway, etiqueta] {Diámetro externo =  16   dm };
  \draw[linea_medida] (0,3.5) -- (0.75,3.5) node[midway, etiqueta, above] {Radio interno =  7   dm };
  ...
  % Etiqueta de grosor
  \draw[linea_medida] (-1.25,2) -- (-0.75,2) node[midway, etiqueta, above] {Grosor =  1   dm };
