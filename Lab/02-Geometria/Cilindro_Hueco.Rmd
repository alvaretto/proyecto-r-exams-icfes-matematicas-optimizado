...
```{r, echo=FALSE, fig.width=6, fig.height=5, fig.align='center', fig.path="images", dev="png"}
# Crear la figura del cilindro hueco
par(mar = c(2, 2, 2, 2))
...
<!--
```{r, echo=FALSE, fig.width=6, fig.height=5, fig.align='center', include=FALSE}
