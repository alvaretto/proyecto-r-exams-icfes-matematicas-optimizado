...
En un estudio sobre rendimiento académico universitario, se registraron las siguientes `r length(datos)` calificaciones obtenidas por estudiantes en la prueba de matemáticas:
