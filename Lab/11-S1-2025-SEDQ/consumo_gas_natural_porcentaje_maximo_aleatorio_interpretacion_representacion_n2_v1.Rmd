...
# Generar datos económicos coherentes con el consumo de octubre
cargo_fijo <- sample(c(2500, 2700, 2800, 3000, 3200), 1)

# Obtener el consumo de octubre de la gráfica
consumo_octubre <- consumos[which(names(consumos) == "Octubre")]

# Calcular el costo variable basado en el consumo de octubre
...
# Calcular el total de la factura de octubre
...
test_that("Validación de coherencia económica", {
  # Verificar que la factura es coherente con el consumo de octubre
  factura_calculada <- cargo_fijo + (consumo_octubre * precio_por_m3)
