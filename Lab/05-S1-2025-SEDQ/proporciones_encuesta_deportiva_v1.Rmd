...
# POOL DE DISTRACTORES CON EQUIPOS ÚNICOS GARANTIZADOS
distractores_por_tipo <- list()
...
# 1C: Fracción reducida con equipo incorrecto
fraccion_dist1 <- generar_fraccion_reducida(valor_distractor1, tamano_muestra)
if (fraccion_dist1[1] != valor_distractor1 || fraccion_dist1[2] != tamano_muestra) {
  num_dist1_red <- formatear_entero(fraccion_dist1[1])
  den_dist1_red <- formatear_entero(fraccion_dist1[2])
  distractores_tipo1 <- c(distractores_tipo1,
    paste0("alrededor de ", num_dist1_red, " de cada ", den_dist1_red, " ",
           termino_usuarios, " del ", contexto, " da por favorito al ", equipo_distractor1, "."))
}

distractores_por_tipo[["tipo1"]] <- distractores_tipo1

# TIPO 2: Distractores con equipo_distractor2
distractores_tipo2 <- c()

# 2A: Proporción correcta con equipo incorrecto
distractores_tipo2 <- c(distractores_tipo2,
  paste0("alrededor de ", valor_distractor2_fmt, " de cada ", tamano_muestra_fmt, " ",
         termino_usuarios, " del ", contexto, " da por favorito al ", equipo_distractor2, "."))

# 2B: Confusión muestra-población con equipo incorrecto
distractores_tipo2 <- c(distractores_tipo2,
  paste0("alrededor de ", valor_distractor2_fmt, " de cada ", poblacion_total_fmt, " ",
         termino_usuarios, " del ", contexto, " da por favorito al ", equipo_distractor2, "."))

# 2C: Fracción reducida con equipo incorrecto
fraccion_dist2 <- generar_fraccion_reducida(valor_distractor2, tamano_muestra)
if (fraccion_dist2[1] != valor_distractor2 || fraccion_dist2[2] != tamano_muestra) {
  num_dist2_red <- formatear_entero(fraccion_dist2[1])
  den_dist2_red <- formatear_entero(fraccion_dist2[2])
  distractores_tipo2 <- c(distractores_tipo2,
    paste0("alrededor de ", num_dist2_red, " de cada ", den_dist2_red, " ",
           termino_usuarios, " del ", contexto, " da por favorito al ", equipo_distractor2, "."))
}

distractores_por_tipo[["tipo2"]] <- distractores_tipo2

# TIPO 3: Distractores con equipo_distractor3 o conceptuales
distractores_tipo3 <- c()

# 3A: Proporción correcta con equipo incorrecto
distractores_tipo3 <- c(distractores_tipo3,
  paste0("alrededor de ", valor_distractor3_fmt, " de cada ", tamano_muestra_fmt, " ",
...
distractores_por_tipo[["tipo3"]] <- distractores_tipo3
...
for (opcion in opciones) {
  ...
  # También verificar equipos no incluidos
  for (equipo in setdiff(equipos_disponibles, equipos_seleccionados)) {
    if (grepl(equipo, opcion, fixed = TRUE)) {
      equipos_mencionados <- c(equipos_mencionados, equipo)
    }
  }
