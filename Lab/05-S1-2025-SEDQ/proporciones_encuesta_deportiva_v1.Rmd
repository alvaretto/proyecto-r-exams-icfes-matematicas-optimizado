...
# 1C: Error de interpretación de porcentaje con equipo incorrecto
porcentaje_dist1 <- round(valor_distractor1 / tamano_muestra * 100)
if (porcentaje_dist1 != valor_distractor1 && porcentaje_dist1 > 0) {
  distractores_tipo1 <- c(distractores_tipo1,
    paste0("alrededor de ", formatear_entero(porcentaje_dist1), " de cada ", tamano_muestra_fmt, " ",
           termino_usuarios, " del ", contexto, " da por favorito al ", equipo_distractor1, "."))
}
...
# 2C: Error de interpretación de porcentaje con equipo incorrecto
porcentaje_dist2 <- round(valor_distractor2 / tamano_muestra * 100)
if (porcentaje_dist2 != valor_distractor2 && porcentaje_dist2 > 0) {
  distractores_tipo2 <- c(distractores_tipo2,
    paste0("alrededor de ", formatear_entero(porcentaje_dist2), " de cada ", tamano_muestra_fmt, " ",
           termino_usuarios, " del ", contexto, " da por favorito al ", equipo_distractor2, "."))
}
...
# ELIMINADA: Verificación de fracción reducida (ya no se usan fracciones equivalentes)
