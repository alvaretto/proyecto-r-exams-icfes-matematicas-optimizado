...
# La respuesta correcta es sobre el equipo seleccionado ALEATORIAMENTE (no siempre el de más votos)
...
# Distractores plausibles (INDEPENDIENTES DEL EQUIPO CORRECTO SELECCIONADO)
# Distractor 1: Confunde muestra con población usando el equipo correcto
distractor1 <- paste0("alrededor de ", valor_correcto_fmt, " de cada ", poblacion_total_fmt, " ",
                     termino_usuarios, " del ", contexto, " da por favorito al ", equipo_correcto, ".")

# Distractor 2: Afirma que ninguno prefiere un equipo no incluido en la muestra
...
# Distractor 3: Confunde tamaño de muestra con preferencias totales
