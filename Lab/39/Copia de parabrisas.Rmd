...
# Código Python mejorado para generar el diagrama de plumillas con ángulo
...
# Añadir etiqueta para la segunda plumilla
ax.annotate("Plumilla", xy=(4.45, 1.7), xytext=(5.6, 1.5),
            arrowprops=dict(facecolor="black", arrowstyle="->", linewidth=1),
