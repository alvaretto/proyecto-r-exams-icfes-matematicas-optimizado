...
- P(`r termino_menores_seleccionado` de `r edad_corte_seleccionada` años ∩ `r termino_masculino_seleccionado`) = `r p_menor_masc`
- P(`r termino_menores_seleccionado` de `r edad_corte_seleccionada` años ∩ `r termino_femenino_seleccionado`) = `r p_menor_fem`
- P(`r termino_mayores_seleccionado` de `r edad_corte_seleccionada` años ∩ `r termino_masculino_seleccionado`) = `r p_mayor_masc`
- P(`r termino_mayores_seleccionado` de `r edad_corte_seleccionada` años ∩ `r termino_femenino_seleccionado`) = `r p_mayor_fem`
