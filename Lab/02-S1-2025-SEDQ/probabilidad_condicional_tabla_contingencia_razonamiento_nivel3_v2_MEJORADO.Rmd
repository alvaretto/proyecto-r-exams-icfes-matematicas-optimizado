...
test_that("Función de escape LaTeX funciona correctamente", {
  ...
  expect_true(grepl("m\\\\'{a}s", texto_escapado))
  expect_true(grepl("a\\\\~{n}os", texto_escapado))
  expect_false(grepl("á", texto_escapado))
  expect_false(grepl("ñ", texto_escapado))
})
...
test_that("Renderizado LaTeX es seguro y correcto", {
  ...
  if(grepl("á", pregunta_seleccionada$texto_evento)) {
    expect_true(grepl("\\\\'{a}", texto_evento_latex_safe))
  }
  if(grepl("ñ", pregunta_seleccionada$texto_evento)) {
    expect_true(grepl("\\\\~{n}", texto_evento_latex_safe))
  }
})
