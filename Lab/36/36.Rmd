...
exextra[Estandar]: Interpreto analítica y críticamente información estadística.
exextra[Aprendizaje]: Establecer procedimientos para hallar medidas de superficies y volúmenes.
exextra[Evidencia]: Resolver problemas que involucran el cálculo de áreas y volúmenes.
exextra[Componente]: Espacial-Métrico
exextra[Proceso]: Argumentación
exextra[Contexto]: Matemático
exextra[Estrategia]: Analizar información presentada en gráficos estadísticos.
exextra[Tiempo]: 8 minutos
exextra[Pregunta]: 1
exextra[Aleatorización]: No
