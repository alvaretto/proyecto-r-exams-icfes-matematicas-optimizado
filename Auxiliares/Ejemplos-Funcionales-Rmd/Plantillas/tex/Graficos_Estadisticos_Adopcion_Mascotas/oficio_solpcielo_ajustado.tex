...
% CONFIGURACIÓN ESPECÍFICA: TABLAS MÁS PEQUEÑAS
\renewcommand{\arraystretch}{0.7}
\setlength{\tabcolsep}{2pt}

% CONFIGURACIÓN ESPECÍFICA: GRÁFICOS MÁS GRANDES
\pgfplotsset{
    tick label style={font=\small},        % Etiquetas de ejes más grandes
    label style={font=\normalsize},        % Labels más grandes
    legend style={font=\small},            % Leyenda más grande
    title style={font=\normalsize},        % Títulos más grandes
...
% Configuración de TikZ para texto más grande en gráficos
\tikzset{
    every node/.style={font=\small},       % Nodos más grandes
    every label/.style={font=\small},      % Labels más grandes
    every pin/.style={font=\small}         % Pins más grandes
}

% REDEFINIR SOLO EL ENTORNO TABULAR PARA HACERLO MÁS PEQUEÑO
\let\oldtabular\tabular
\let\endoldtabular\endtabular
\renewenvironment{tabular}[1]{%
  \footnotesize                            % Texto más pequeño en tablas
  \setlength{\tabcolsep}{1.5pt}           % Espaciado mínimo
  \renewcommand{\arraystretch}{0.8}       % Filas más compactas
  \oldtabular{#1}
}{%
  \endoldtabular
}
...
%% paragraphs
\setlength{\parskip}{0.6ex plus0.1ex minus0.1ex}
