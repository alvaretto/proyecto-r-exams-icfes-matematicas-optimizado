...
\usepackage{tikz}
\usepackage{pgfplots}
\usepackage{a4wide,color,verbatim,Sweave,url,xargs,amsmath,tabu,multicol,pgfplots,graphicx,booktabs,array,tabularx,ltxtable,adjustbox}
...
% Configuración de tablas para dos columnas
\renewcommand{\arraystretch}{1.0}
\setlength{\tabcolsep}{1pt}

% Redefinir TODOS los entornos de tabla para forzar adaptación MÁXIMA
...
\renewenvironment{tabular}[1]{%
  ...
  \begin{oldtabular}{@{}l@{\hspace{2pt}}c@{}}
}{%
  \end{oldtabular}
  \end{adjustbox}
}

% Redefinir también tabular* si existe
\@ifundefined{tabular*}{}{%
\let\oldtabularstar\tabular*
\let\endoldtabularstar\endtabular*
\renewenvironment{tabular*}[2]{%
  \tiny
  \setlength{\tabcolsep}{0.5pt}
  \begin{adjustbox}{width=0.95\columnwidth,center}
  \begin{oldtabularstar}{#1}{@{}l@{\hspace{2pt}}c@{}}
}{%
  \end{oldtabularstar}
  \end{adjustbox}
}}
