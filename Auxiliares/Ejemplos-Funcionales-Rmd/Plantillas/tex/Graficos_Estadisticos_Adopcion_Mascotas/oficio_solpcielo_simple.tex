...
%% packages básicos
\usepackage[papersize={215.9mm,355.6mm},tmargin=10mm,bmargin=15mm,lmargin=10mm,rmargin=10mm]{geometry}
\usepackage{amsmath,amssymb,amsfonts,latexsym,cancel,amsthm}
\usepackage[table,xcdraw]{xcolor}
\usepackage{tikz}
\usepackage{pgfplots}
\usepackage{color,verbatim,url,xargs,amsmath,multicol,graphicx,booktabs,longtable}
...
% SOLUCIÓN SIMPLE: NO redefinir entornos, solo configurar parámetros básicos
