...
exams2pdf(examen01,name="Pedorros_",encoding="UTF-8",n=1,template=("nuevotaller"),dir="salida",edir="ejercicios")
#set.seed(semilla) 
exams2pdf(examen01,name="Respuestas_Pedorros_",encoding="UTF-8",n=1,template=c("soluciontallerespc"),dir="salida",edir="ejercicios")
#set.seed(semilla) 
exams2html("Pedorros3.Rmd",svg=TRUE)
##set.seed(semilla) 
