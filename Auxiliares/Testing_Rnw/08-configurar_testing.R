...
generar_reporte_configuracion <- function(resultados) {
  ...
  if (porcentaje >= 80) {
    ...
    cat("\n🚀 PRÓXIMOS PASOS:\n")
    cat("1. Línea de comandos: Rscript 05-test_rnw_simple.R archivo.Rnw\n")
    cat("2. Testing completo: Rscript 06-test_rnw_completo.R archivo.Rnw\n")
    cat("3. Desde RStudio: setwd('Auxiliares/Testing_Rnw') + source('05-test_rnw_simple.R')\n")
    cat("4. Leer documentación: 00-README.md\n")
