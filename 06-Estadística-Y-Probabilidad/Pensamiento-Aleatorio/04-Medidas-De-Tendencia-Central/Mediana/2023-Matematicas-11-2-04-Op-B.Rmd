...
while (mediana_deseada_y == mediana_deseada_x) {
  matriz_datos[2,] <- matriz_datos[2,] + sample(-5:5, 5, replace = TRUE)
  mediana_deseada_y <- median(sort(matriz_datos[2,]))
}
...
matriz_datos[3, 3] <- max_mediana_xy + sample(5:15, 1)  # Ajuste sutil para la mediana
matriz_datos[3, 4:5] <- matriz_datos[3, 4:5] + sample(10:20, 2, replace = TRUE)  # Ajuste para valores mayores
