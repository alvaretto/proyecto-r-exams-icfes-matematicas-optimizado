...
generar_datos <- function() {
  ...
  # Ejemplo de datos (debe ser reemplazado con la lógica real)
  datos <- data.frame(
    x = rnorm(10),
    y = runif(10)
  )
...
# datos <- generar_datos() # Comentado para evitar errores iniciales
```
