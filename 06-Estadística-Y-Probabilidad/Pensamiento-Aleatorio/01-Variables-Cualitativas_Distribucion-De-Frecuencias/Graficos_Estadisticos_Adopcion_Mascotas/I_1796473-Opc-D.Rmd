...
python_paths <- c("/usr/bin/python3.11", "/home/garuda/.virtualenvs/r-reticulate/bin/python")
...
cantidad = [porcentaje3py, porcentaje2py, porcentaje1py]
...
# Resto del código de personalización adaptado para barras horizontales
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
ax.spines['left'].set_linewidth(2)
ax.spines['bottom'].set_linewidth(2)
...
plt.xticks(np.arange(0, mashorpy+10, 10), fontweight='bold')  # Ajuste en el rango para xticks
