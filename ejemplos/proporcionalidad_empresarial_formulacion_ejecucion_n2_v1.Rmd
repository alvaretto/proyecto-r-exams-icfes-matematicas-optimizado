...
icfes:
  ...
  afirmacion: Resuelve problemas que requieren el uso de proporcionalidad
  evidencia: Utiliza proporciones para resolver problemas de reparto proporcional
  nivel: Medio
  tematica: Proporcionalidad y reparto proporcional
---
...
# Aleatorización de nombres de socios (diversidad de género)
...
- Estado: `r if(abs(procedimiento1$calculo - ganancia_correcta) < 0.01) "CORRECTO" else "INCORRECTO"`

**Procedimiento 2:** `r procedimiento2$texto`
- Resultado: $`r format(procedimiento2$calculo * 1000000, big.mark=".", decimal.mark=",")`
- Estado: `r if(abs(procedimiento2$calculo - ganancia_correcta) < 0.01) "CORRECTO" else "INCORRECTO"`
...
**Total verificado**: $`r format(ganancias_total * 1000000, big.mark=".", decimal.mark=",")` (CORRECTO)
