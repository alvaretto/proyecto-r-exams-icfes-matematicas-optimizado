...
# Script para generar exámenes en formato PDF y DOCX a partir del archivo Rmd modificado

# Cargar librerías necesarias
library(exams)

# Archivo de entrada
input_file <- "ExamenFinPeriodo-1/schoice-DVenn_All_GenMus_01_modified.Rmd"
...
base_name <- "DiagramaVenn_GenerosMusicales"
