...
# Verificar y crear directorio de biblioteca si no existe
...
cat("=== Instalando paquetes básicos ===\n")
install_if_missing(c("jsonlite", "xml2", "curl", "httr"))
...
if(require("tinytex")) {
  ...
  cat("No se pudo cargar el paquete tinytex. Por favor, instálalo manualmente.\n")
}

# Lista de paquetes necesarios para r-exams
cat("\n=== Instalando paquetes para r-exams ===\n")
paquetes <- c(
...
# Instalar paquetes LaTeX adicionales si TinyTeX está instalado
if(require("tinytex") && tinytex::is_tinytex()) {
  cat("\n=== Instalando paquetes LaTeX adicionales ===\n")
...
if(require("reticulate")) {
  cat("\n=== Configurando Python para reticulate ===\n")
...
cat("Ruta de la biblioteca de usuario: ", user_lib, "\n")
