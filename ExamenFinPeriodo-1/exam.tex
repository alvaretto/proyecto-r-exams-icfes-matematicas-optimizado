...
\usepackage{multicol} % Para diseño a doble columna [[5]]
\usepackage[a4paper, margin=1.5cm]{geometry} % Márgenes estrechos usando geometry [[2]]
\usepackage{fancyhdr} % Para modificar encabezados y pies de página [[1]]
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{Matemáticas \myDate}}
\fancyhead[R]{\textbf{Taller ID \myID}}
...
% Comenzar diseño a doble columna
\begin{multicols}{2}
