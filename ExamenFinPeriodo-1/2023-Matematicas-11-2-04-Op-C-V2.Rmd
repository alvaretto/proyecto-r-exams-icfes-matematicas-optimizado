...
if (mediana_deseada_z != mediana_deseada_x) {
  # Ajustamos la mediana de Z para que vuelva a ser igual a X
  matriz_datos[3,] <- sort(matriz_datos[1,])
  matriz_datos[3,] <- matriz_datos[3,] + sample(-20:20, num_pruebas, replace = TRUE)
  while (median(sort(matriz_datos[3,])) != mediana_deseada_x) {
    matriz_datos[3,] <- sort(matriz_datos[1,])
...
if (mediana_deseada_y <= mediana_deseada_x) {
  # Ajustamos la mediana de Y para que vuelva a ser mayor que X
  matriz_datos[2,] <- matriz_datos[2,] + (mediana_deseada_x - mediana_deseada_y + 10)
}
