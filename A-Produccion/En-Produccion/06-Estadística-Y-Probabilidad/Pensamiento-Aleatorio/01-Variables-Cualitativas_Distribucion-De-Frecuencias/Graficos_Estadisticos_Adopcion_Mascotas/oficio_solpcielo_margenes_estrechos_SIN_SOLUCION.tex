...
% Configuración de dos columnas con separador visible - ESPACIADO OPTIMIZADO
...
\newenvironment{solution}{\comment}{\endcomment}  % OCULTAR SOLUCIONES PARA ESTUDIANTES
...
\newcommand{\extext}[1]{}  % OCULTAR MARCAS DE RESPUESTAS CORRECTAS PARA ESTUDIANTES
