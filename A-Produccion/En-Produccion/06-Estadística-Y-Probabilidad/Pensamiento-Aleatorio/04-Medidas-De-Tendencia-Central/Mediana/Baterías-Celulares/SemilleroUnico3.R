...
archivo_examen <- c("2023-Matematicas-11-2-04-Op-B-V2.Rmd", 
                    "2023-Matematicas-11-2-04-Op-C-V2.Rmd")
copias <- 1
numpreg_por_archivo <- 5  # n preguntas por cada archivo
...
nombre_sin_extension <- "06-Mediana-sol"  # Cambiado a un nombre genérico para el taller
...
exams2pdf(rep(archivo_examen, each = numpreg_por_archivo),  # n preguntas de cada archivo
          n = copias,
          name = "06-Mediana-sol-espitia",  # Corregido: nombre como string
          encoding = "UTF-8",
          template = "exam",
          dir = dir_salida,
          edir = dir_ejercicios)
