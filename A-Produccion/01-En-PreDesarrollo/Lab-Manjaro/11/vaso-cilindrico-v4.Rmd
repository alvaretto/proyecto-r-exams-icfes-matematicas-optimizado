...
# La respuesta correcta es la opción 2 (área de la tapa)
solucion <- 2
...
$$\pi \times `r radio`^2 = `r area_base_redondeada`$$
...
Para resolver este problema, debemos identificar qué cálculo se está realizando con la fórmula $\pi \times `r radio`^2 = `r area_base_redondeada`$.
...
$A = \pi \times `r radio`^2 = `r area_base_redondeada` \text{ cm}^2$
