...
# NOTA: Funciones vacías para evitar problemas en XML
# El espaciado se maneja directamente con saltos de línea en LaTeX
espaciado_grande <- function() {
  ""  # Función vacía - espaciado manejado en LaTeX
}
