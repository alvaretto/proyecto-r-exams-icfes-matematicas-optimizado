...
explicaciones_errores <- list(
  ...
  error2 = "- La pirueta no muestra un descenso constante como indicó el piloto, sino que presenta un pico hacia arriba (aumento de altura) antes del descenso, lo cuál contradice la descripción.",
