...
answers <- c(
  ...
  n_AB_only + n_AC_only + n_BC_only + n_all, # Personas que escuchan al menos dos géneros
  n_AB_only + n_AC_only + n_BC_only, # Personas que escuchan exactamente dos géneros
  n_only_A + n_only_B + n_AC_only + n_BC_only, # Personas que escuchan A o B, pero no ambos
  n_only_A + n_AC_only, # Personas que escuchan A pero no B
  n_A + n_C - n_AC,
  n_total - (n_B + n_C - n_BC),
  n_total - n_none,
  n_only_A + n_only_B + n_only_C,
  n_none + n_only_A + n_only_B + n_only_C + n_AB_only + n_AC_only + n_BC_only, # Personas que escuchan máximo dos géneros
  n_total # Todas las personas escuchan máximo tres géneros
)
