...
if (iter >= max_iter) {
  ...
  target <- vals[3]
  vals[1] <- target - sample(20:50, 1)
  vals[2] <- target - sample(1:19, 1)
  vals[4] <- target + sample(1:19, 1)
  vals[5] <- target + sample(20:50, 1)
  matriz_datos[3,] <- sample(vals)
}
...
Meta-information
============
exname: comparar_medianas_baterias_celulares_aleatorio_interpretacion_representacion_n2_schoice_v2
extype: schoice
exsolution: 0010
exshuffle: TRUE
extol: 0.01
