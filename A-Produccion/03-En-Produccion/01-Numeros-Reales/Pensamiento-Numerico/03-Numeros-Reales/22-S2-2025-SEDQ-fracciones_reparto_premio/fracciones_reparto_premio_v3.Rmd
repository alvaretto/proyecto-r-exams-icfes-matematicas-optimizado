...
### Paso 2: Convertir la fracción del segundo puesto a decimal
...
- Monto del segundo puesto = `r fraccion_segundo_puesto` × `r premio_total` millones
- Monto del segundo puesto = `r valor_segundo_puesto` × `r premio_total` millones
- Monto del segundo puesto = `r round(monto_segundo_puesto_exacto, 2)` millones
...
exextra[Afirmacion]: Resuelve problemas con fracciones y repartos proporcionales
