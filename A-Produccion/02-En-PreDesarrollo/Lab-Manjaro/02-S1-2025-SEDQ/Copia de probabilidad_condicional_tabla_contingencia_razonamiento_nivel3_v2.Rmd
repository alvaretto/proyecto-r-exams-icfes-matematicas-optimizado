...
p_menor_masc <- proporciones_generadas[1]  # P(Menor y Masculino)
p_menor_fem <- proporciones_generadas[2]   # P(Menor y Femenino)
p_mayor_masc <- proporciones_generadas[3]  # P(Mayor y Masculino)
p_mayor_fem <- proporciones_generadas[4]   # P(Mayor y Femenino)
...
- $P(A \text{ y } B)$ = probabilidad de que ocurran ambos eventos simultáneamente
...
- P(`r termino_menores_seleccionado` de `r edad_corte_seleccionada` años y `r termino_masculino_seleccionado`) = `r sprintf("%.3f", p_menor_masc)`
- P(`r termino_menores_seleccionado` de `r edad_corte_seleccionada` años y `r termino_femenino_seleccionado`) = `r sprintf("%.3f", p_menor_fem)`
- P(`r termino_mayores_seleccionado` de `r edad_corte_seleccionada` años y `r termino_masculino_seleccionado`) = `r sprintf("%.3f", p_mayor_masc)`
- P(`r termino_mayores_seleccionado` de `r edad_corte_seleccionada` años y `r termino_femenino_seleccionado`) = `r sprintf("%.3f", p_mayor_fem)`
...
$$P(\text{`r pregunta_seleccionada$texto_evento`} | \text{`r pregunta_seleccionada$texto_condicion`}) = \frac{P(\text{`r pregunta_seleccionada$texto_evento`} \text{ y } \text{`r pregunta_seleccionada$texto_condicion`})}{P(\text{`r pregunta_seleccionada$texto_condicion`})}$$
