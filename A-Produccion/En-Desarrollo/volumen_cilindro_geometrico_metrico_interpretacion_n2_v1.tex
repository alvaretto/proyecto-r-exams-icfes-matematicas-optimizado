...
Un estudiante tiene un lata de forma cilíndrica. El lata tiene una base
circular de radio 5 cm y una altura de 10 cm, como se muestra en la
figura.
...
\draw[<->, red] (0, \altura) -- (\radio, \altura) node[midway, above, font=\small, transform shape=false] {5 cm};
...
\tightlist
\item
  Al perímetro de la tapa del lata.
\item
  Al área lateral del lata.
\item
  Al volumen del lata.
\item
  Al área de la tapa del lata.
\end{itemize}
...
La expresión \(\pi \times 5^2 \times 10\) tiene la estructura:
...
\[V = \pi r^2 h = \pi \times 5^2 \times 10 = 785.4 \text{ cm}^3\]
...
\textbf{Área lateral:}
\[A_{lateral} = 2\pi r h = 2 \times \pi \times  5  \times  10  =  314.16  \text{ cm}^2\]
Esta fórmula NO incluye \(r^2\) (solo \(r\)).

\subsubsection{Conclusión}\label{conclusiuxf3n}

La operación \(\pi \times 5^2 \times 10 = 785.4\) corresponde al
\textbf{volumen del lata}, medido en centímetros cúbicos (cm³).
