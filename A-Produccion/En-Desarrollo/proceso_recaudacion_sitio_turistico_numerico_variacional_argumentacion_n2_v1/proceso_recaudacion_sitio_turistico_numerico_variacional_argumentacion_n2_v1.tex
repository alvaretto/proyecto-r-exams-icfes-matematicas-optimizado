...
El parque Güell en Barcelona es uno de los sitios turísticos más
representativos de España. En la tabla se relaciona la cantidad de
personas que ingresó cada día durante una semana, según el tipo de
entrada que pagó.

Se pagan 16 euros de entrada y 7 más si se realiza reserva.
...
\bottomrule\noalign{}
\endlastfoot
Sin reserva & 400 & 400 & 500 & 600 & 500 & 300 & 700 \\
Con reserva & 600 & 800 & 200 & 600 & 600 & 600 & 600 \\
\end{longtable}
...
\item
  ...
  semana?
\item
  ¿Cuál fue la ganancia total del parque Güell durante la semana?
\end{itemize}
...
\item
  ...
  dinero se recogió de personas con reserva (cantidad × 23 euros) y sin
  reserva (cantidad × 16 euros).
\item
...
\item
  ...
  operativos del parque Güell (personal, mantenimiento, servicios,
  etc.), información que no está incluida en el proceso.
\item
